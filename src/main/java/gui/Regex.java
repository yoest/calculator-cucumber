...
public class Regex {
    ...
    public  static  String INTEGER_BASE_33 = "[0-9A-Wa-w\\|%$+\\-/()\\s\\*]*";

    public static String INTEGER_BASE_34 = "[0-9A-Xa-x\\|%$+\\-/()\\s\\*]*";

    public static String INTEGER_BASE_35 = "[0-9A-Ya-y\\|%$+\\-/()\\s\\*]*";

    public static String INTEGER_BASE_36 = "[0-9A-Za-z\\|%$+\\-/()\\s\\*]*";
